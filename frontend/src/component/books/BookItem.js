...
import { useDeleteBookMutation } from "../../features/books/api/bookSlice";

function BookItem(bookDetails) {
  const { name, author, thumbnail, price, rating, featured, id } = bookDetails;
      ...
      <div className="flex-1 h-full pr-2 pt-2 flex flex-col">
        ...
        <div className="space-y-2 mt-4 h-full">
          ...
          <div className="lws-stars">
            {[...Array(customRating(rating)).keys()].map((item, index) => (
              <svg
                viewBox="0 0 20 20"
                fill="currentColor"
                className="star"
